...
export const constantRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views//assignment/task'),
        hidden: false,
        meta: { title: '任务列表', icon: 'dashboard', affix: true }
      },
      {
        path: '/lesson/lessonList',
        component: () => import('@/views//lesson/lessonList'),
        hidden: false,
        meta: { title: '课程列表', icon: 'dashboard', affix: true }
      },
      {
        path: '/assignment/taskReceive',
        component: () => import('@/views//assignment/taskClassify'),
        hidden: false,
        meta: { title: '审核列表', icon: 'dashboard', affix: true }
      },
      {
        path: '/assignment/taskClassify',
        component: () => import('@/views//assignment/taskReceive'),
        hidden: false,
        meta: { title: '任务分类', icon: 'dashboard', affix: true }
      },{
        path: '/receiver/person',
        component: () => import('@/views//receiver/person'),
        hidden: false,
        meta: { title: '账号列表', icon: 'dashboard', affix: true }
      },{
        path: '/receiver/withdrawRecord',
        component: () => import('@/views//receiver/withdrawRecord'),
        hidden: false,
        meta: { title: '提现记录', icon: 'dashboard', affix: true }
      }
      ,{
        path: '/receiver/walletBill',
        component: () => import('@/views//receiver/walletBill'),
        hidden: false,
        ...
        component: () => import('@/views//receiver/member'),
        hidden: false,
        meta: { title: '充值记录', icon: 'dashboard', affix: true }
      },{
        path: '/receiver/invite',
        component: () => import('@/views//receiver/invite'),
        hidden: false,
        meta: { title: '分销记录', icon: 'dashboard', affix: true }
      },
      {
        path: '/system/role',
      ...
      {
        path:"/system/dept",
        component: () => import('@/views//system/depts'),
        hidden: false,
