<template>
    ...
    <!-- <el-table-column prop="date" label="提现单号" width="150" /> -->
    <el-table-column prop="numberId" label="会员编号" width="140" />
    <el-table-column prop="nickName" label="用户昵称" width="120" />
    <el-table-column prop="state" label="手机号" width="140" />
    <el-table-column prop="amount" label="金额(元)" width="120" />
    <el-table-column prop="type" label="账单类型" width="120" >
      <template #default="scope">
        {{ scope.row.type==0?'提现':"收入" }}
      </template>
    </el-table-column>
    <el-table-column prop="city" label="外部关联ID" width="180" />
    <el-table-column prop="name" label="账单分类" width="120" />
    <el-table-column prop="createTime" label="账单时间" width="120" >
      <template #default="scope">
 ...
 banlaceList
import {banlaceList} from "@/api/assignment/index.js"
...
// import Editor from '@/components/WangEditor/index.vue';
 ...
 function getList() {
   ...
   let data={
    ...
    id:queryParams.value.phone,
    numberId:queryParams.value.nicname,
    type:queryParams.value.tashTitle,
    startTime:dateRange.value[0],
    endTime:dateRange.value[1]
   }
  //  console.log(queryParams.value,dateRange.value,"搜索值")
   banlaceList(data).then(response => {
