<template>
    <div class="app-container">
       <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
          ...
          <el-form-item>
             <el-button class="btn" type="success" icon="Search" @click="handleQuery">搜索</el-button>
             <el-button class="btn" style="background-color: #F5BF45;color: #fff;" icon="Refresh" @click="resetQuery">重置</el-button>
          </el-form-item>
       </el-form>
       ...
       <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
             <el-button class="btn"
             style="background-color: #F5BF45;color: #fff;"
                type="warning"
                icon="Download"
                @click="handleExport"
       ...
       <el-table  :data="postList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="名称" align="center" prop="postId" />
          <el-table-column label="所属部门" align="center" prop="postCode" />
          <el-table-column label="排序" align="center" prop="postName" />
